...
// Core functions
*/
AESDK_OpenGL_Err AESDK_OpenGL_InitResources(AESDK_OpenGL_EffectCommonData& inData, u_short inBufferWidth = 1920, u_short inBufferHeight = 1080);
